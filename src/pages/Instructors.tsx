            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div className="bg-gradient-to-br from-turquoise-50 via-pink-50 to-white/90 border border-turquoise-100 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="h-96 overflow-hidden">
                  <OptimizedImage
                      src="/images/IMG/秋間まゆインストラクターソフティスピラティス.jpeg"
              ...
              <div className="bg-gradient-to-br from-turquoise-50 via-pink-50 to-white/90 border border-turquoise-100 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="h-96 overflow-hidden">
                  <OptimizedImage
                      src="/images/IMG/三浦　弥生.png"
                      alt={t('instructors.miuraYayoi')}
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-turquoise-700 mb-2">{t('instructors.miuraYayoi')}</h3>
                  <p className="text-turquoise-600 mb-4 text-lg">{t('instructors.miuraRole')}</p>

                  <div className="space-y-4">
                    <div className="bg-white/80 p-4 rounded-lg shadow-sm">
                      <h4 className="font-bold text-turquoise-700 mb-2 text-lg">{t('instructors.miuraGreeting')}</h4>
                      <p className="text-gray-800 leading-relaxed">
                        {t('instructors.miuraGreetingContent')}
                      </p>
                    </div>

                    <div className="bg-white/80 p-4 rounded-lg shadow-sm">
                      <h4 className="font-bold text-turquoise-700 mb-2 text-lg">{t('instructors.miuraQualifications')}</h4>
                      <ul className="list-disc pl-5 space-y-2">
                        <li>{t('instructors.miuraQual1')}</li>
                        <li>{t('instructors.miuraQual2')}</li>
                      </ul>
                    </div>

                    <div className="bg-white/80 p-4 rounded-lg shadow-sm">
                      <h4 className="font-bold text-turquoise-700 mb-2 text-lg">{t('instructors.miuraMessage')}</h4>
                      <p className="text-gray-800 leading-relaxed">
                        {t('instructors.miuraMessageContent')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    <span className="bg-turquoise-100 text-turquoise-700 text-sm px-3 py-1 rounded-full">
                      {t('instructors.miuraSpecialty1')}
                    </span>
                    <span className="bg-turquoise-100 text-turquoise-700 text-sm px-3 py-1 rounded-full">
                      {t('instructors.miuraSpecialty2')}
                    </span>
                    <span className="bg-turquoise-100 text-turquoise-700 text-sm px-3 py-1 rounded-full">
                      {t('instructors.miuraSpecialty3')}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <Container>
            <div className="bg-gradient-to-br from-turquoise-50 via-pink-50 to-white/90 border border-turquoise-100 rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white/80 p-4 rounded-lg shadow-sm flex items-center justify-center">
