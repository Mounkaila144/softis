...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-turquoise-500 text-white hover:bg-turquoise-600 focus:ring-2 focus:ring-turquoise-300',
    outline: 'bg-transparent border border-primary-500 text-primary-500 hover:bg-primary-50',
    gold: 'bg-gold-500 text-primary-900 hover:bg-gold-400 focus:ring-2 focus:ring-gold-300',
  };
